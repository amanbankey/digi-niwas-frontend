  ...
  return (
    <div className="flex-1 max-w-full lg:max-w-[50%] xl:max-w-[45%] text-center lg:text-left">
      ...
      <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-10">
        ...
        <button className="flex items-center gap-2 bg-[#00d9a6] text-[#0d1b2a] font-semibold px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg hover:bg-[#00c49a] transition-all text-sm sm:text-base">
...
function RightPhones() {
  return (
    <div className="flex-1 flex flex-col items-center lg:items-end gap-4 w-full lg:max-w-[55%]  ">
...
function StatsBar() {
  return (
    <div className="mb-6 sm:mb-8 mt-8">
      <div className="bg-white rounded-2xl sm:rounded-3xl px-4 sm:px-6  py-4 sm:py-5 grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
        {[
