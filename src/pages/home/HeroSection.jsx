...
function RightPhones() {
  ...
  "
        >
          <img
            src={'https://res.cloudinary.com/dhuabv2it/image/upload/v1780736766/niwas_jzpp87.png'}
            alt="Niwas AI"
  ...
  "
        >
          <img
            src={'https://res.cloudinary.com/dhuabv2it/image/upload/v1780736767/property_apkuj7.png'}
  ...
  "
        >
          <img
            src={'https://res.cloudinary.com/dhuabv2it/image/upload/v1780736761/dashboard_t6ocdx.png'}
            alt="Dashboard"
            className="w-full h-auto rounded-[24px]"
          />
        </div>
        <div className="absolute hidden xl:block right-14 -bottom-10 z-20">
          ...
          border-white/20 rounded-lg px-3 py-2 sm:px-4 sm:py-3"
              >
                {icon}
                <div className="">
                  ...
                  <div className="text-[#0d1b2a] font-medium text-xs">
                    {sub}
                  </div>
                </div>
              </div>
...
function StatsBar() {
  return (
    <div className="mb-6 sm:mb-8 mt-8">
      <div className="bg-white/80  rounded-3xl px-4 sm:px-6  py-4 sm:py-5 grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
        {[
          {
          ...
          <div key={label} className="flex flex-col items-center   ">
            ...
            <div className="flex flex-col items-center">
              <p className="text-[#0d1b2a]  font-black text-base sm:text-xl leading-tight">
                {num}
              </p>
